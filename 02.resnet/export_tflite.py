"""Export the saved ResNet-18 dg bundle to a full-integer (int8) .tflite file.

Dedicated to the artifact in ./resnet/ (resnet18.pt, resnet18.py, config.json);
writes ./resnet/resnet18.tflite. Activations are calibrated on real CIFAR-10
...
def load_torch_model():
    """Reload the model from the renamed bundle (resnet18.py + resnet18.pt)."""
